...
if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['pwd'])&& isset($_POST['rpwd'])) {
	...
	$user = new utilisateur($_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['pwd'],$_POST['rpwd']);
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="C:\xampp\htdocs\Be_Free_Project\be\back\login\index.html">
							...
							<div class="kt-login__signin">
								...
								<form class="kt-form" method="POST" action="">
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Email" id ="email2" name="email2" autocomplete="off">
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Password" id = "pwd2" name="pwd2">
									</div>
