...
<head>
    ...
    <title> VOITURE DISPONIBLES</title>
...
<body> 
    ...
    <header id="home" class="header">
         ...
         <center><h2>AFFICHAGE DES VOITURE DISPONIBLES</h2></center>
		<table border="2" align="center" >
			...
			<tr>
												...
												<th style="color:black;">Prix par jour</th>
            ...
            <td style="color:black;"><?php echo $voiture['matricule'] ?></td>
                                                    <td style="color:black;"><?php echo $voiture['marque'] ?></td>
                                                    <td style="color:black;"><?php echo $voiture['model'] ?></td>

                                                    <td style="color:black;"><?php echo $voiture['couleur'] ?></td>
                                                    
                                                    <td style="color:black;"><?php echo $voiture['kilometrage'] ?></td>
													<td style="color:black;"><?php echo $voiture['prix'] ?></td>
                                                    <?php }
														 ?>
