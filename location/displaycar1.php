							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
                                    <div class="dropdown dropdown-inline">
                                        <a href="http://localhost/be/location/addcar.php" type="button" class="btn btn-brand btn-icon-sm" style="color: white;">
                                            <i class="flaticon2-plus"></i> Ajouter une voiture
                                        </a>
                                    </div>
								</div>
							</div>
