...
include_once '../Controller/LogementC.php';
    ...
    $Logements = $LogementC->afficherLogement();
?>
<!DOCTYPE html>
								...
								<div class="kt-portlet__body">
									...
									<table class="table" id="kt_table_event">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <th scope="row"><?php echo $Logement['code_log'] ?></th>
                                                    <td><?php echo $Logement['type_log'] ?></td>
                                                    <td><?php echo $Logement['date_debut'] ?></td>
                                                    <td><?php echo $Logement['nb_jours'] ?></td>
													<td><?php echo $Logement['email'] ?></td>
                                                    <td>
                                                        <a href="./update.php?id=<?php echo $Logement['code_log'] ?>" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <a href="./supprimer.php?id=<?php echo $Logement['code_log'] ?>" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
