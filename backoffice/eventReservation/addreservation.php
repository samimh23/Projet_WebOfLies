<?php
	include_once './Model/EventReservation.php';
	include_once './Controller/EventReservationController.php';
									...
									<div class="kt-portlet">
										...
										<form id="form-event" class="kt-form" method="POST" enctype="multipart/form-data">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<label>Email:</label>
													<input type="text" class="form-control" id="event-reservation-email" name="event_reservation_email" placeholder="Enter your Email here">
