						...
						<!-- end:: Subheader -->
							...
							<div class="kt-portlet">
										...
										<div class="form-group form-group-last">
												...
												<input type="text" placeholder="Objet" name="objet" class="form-control" id="objet" readonly value= <?php echo $_GET["objet"] ?> >
											</div>

											<div class="form-group form-group-last">
												<label for="c_email" class="sr-only">Email</label>
												<input type="email" placeholder="E-mail" name="email" class="form-control" id="email" readonly  value= <?php echo $_GET["email"] ?> >
											</div>
											
											<div  class="form-group form-group-last">
												<textarea placeholder="Message" rows="7" name="reponse" id="contenu" class="form-control" required=""></textarea>
											</div>
