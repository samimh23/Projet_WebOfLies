								...
								<div class="kt-subheader__wrapper">
                                    <div class="dropdown dropdown-inline">
                                        <a href="./ajouter.php" type="button" class="btn btn-brand btn-icon-sm" style="color: white;">
                                            <i class="flaticon2-plus"></i> Add Reponse
                                        </a>
                                    </div>
								</div>
							</div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
													...
													<a href="supprimerReponse.php?id=<?php echo $Reponse['id_réponse']; ?>" class="btn btn-danger">Supprimer</a>
													<a href="modifierReponse.php?id=<?php echo $Reponse['id_réponse']; ?>&objet=<?php echo $Reponse['objet']; ?>&email=<?php echo $Reponse['email']; ?>&contenu=<?php echo $Reponse['contenu']; ?>&idd=<?php echo $Reponse['id_reclamation']; ?>" class="btn btn-info">Modifier</a>
