...
<head>
    ...
    <!-- =============== fonts awesome =============== -->
    <link rel="stylesheet" href="../Front/assets/font/css/font-awesome.min.css" type="text/css">
    <!-- =============== Plugin CSS =============== -->
    <link rel="stylesheet" href="../Front/assets/css/animate.min.css" type="text/css">
    <!-- =============== Custom CSS =============== -->
    <link rel="stylesheet" href="../Front/assets/css/style.css" type="text/css">
    <!-- =============== Owl Carousel Assets =============== -->
    <link href="../Front/assets/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="../Front/assets/owl-carousel/owl.theme.css" rel="stylesheet">
	
	 <link rel="stylesheet" href="../Front/assets/css/isotope-docs.css" media="screen">
	  <link rel="stylesheet" href="../Front/assets/css/baguetteBox.css">
...
<body>
    ...
    <div id="preloader">
        <div id="loading">
		<img width="256" height="32" src="../Front/assets/img/loading-cylon-red.svg">	
        </div>
    </div>
    <!-- =============== nav =============== -->
        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="../Front/assets/img/logo.png" alt="Logo">
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInDown animated" data-wow-delay=".5s">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
                     <img src="../Front/assets/img/about-img.jpg"/>               
                  </div>     
            </div>
        </div>   
		<!-- =============== container end =============== -->		
        ...
        <div class="container">            
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".1s">
					<div class="timg"><img src="../Front/assets/img/mehdi.gif"/></div>
				 <div class="t-box">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".1s">
					<div class="timg"><img src="../Front/assets/img/nassim.jpg"/></div>
				 <div class="t-box">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".2s">
				 <div class="timg"><img src="../Front/assets/img/ghaith.gif"/></div>
					<div class="t-box">
						<h3>GHAYTH SELMI</h3>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".3s">
				 <div class="timg"><img src="../Front/assets/img/sami.jpg"/></div>
					<div class="t-box">
						<h3>SAMI MAHJOUB</h3>
		 ...
		 <div class="row">
			 <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".4s">
				 <div class="timg"><img src="../Front/assets/img/baha.jpg"/></div>
				 <div class="t-box">
						<h3>BAHA ADOUANIA</h3>
        ...
        <div class="container">            
            <div class="row">
			 <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInLeft animated" data-wow-delay=".5s">
                     <img src="../Front/assets/img/services-img.jpg" class="img-left"/>               
                  </div>     
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
                   <h2>Services</h2>
...
nullam rhoncus tortor at dignissim vehicula.</p>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownRight animated" data-wow-delay=".4s">
				...
				<div class="wbox">
					...
					<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Vestibulum ac vehicula leo dulam 
nullam rhoncus tortor at dignissim vehicula.</p>
					<a href="./réponse/index.html" class="clr4-a">+</a>
				</div>
...
<!-- =============== Gallery =============== -->
  ...
  <div class="grid baguetteBoxThree gallery">
	  ...
	  <a href="../Front/assets/img/gallery/emp-1.jpg">	 
	  <img src="../Front/assets/img/gallery/emp-1.jpg"/>      
		<div class="hover-img"> 
	  ...
	  <a href="../Front/assets/img/gallery/emp-2.jpg">	 
        <img src="../Front/assets/img/gallery/emp-2.jpg"/>    
		<div class="hover-img"> 
		<h2>E-commerce</h2>
		<i class="fa fa-camera camera"></i>
		</div>		
	  ...
	  <a href="../Front/assets/img/gallery/emp-3.jpg">	 
		<img src="../Front/assets/img/gallery/emp-3.jpg"/>       
		<div class="hover-img"> 
		<h2>Website Design</h2>
		<i class="fa fa-camera camera"></i>
		</div>		
	 ...
	 <div class="element-item transition ecommerce " data-category="post-transition">
	   <a href="../Front/assets/img/gallery/emp-4.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-4.jpg"/>       
		<div class="hover-img"> 
		<h2>E-commerce</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition logo " data-category="post-transition">
         <a href="../Front/assets/img/gallery/emp-5.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-5.jpg"/>       
		<div class="hover-img"> 
		<h2>Logo</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition cms " data-category="post-transition">
		 <a href="../Front/assets/img/gallery/emp-6.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-6.jpg"/>       
		<div class="hover-img"> 
		<h2>CMS</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item post-transition logo " data-category="post-transition">
         <a href="../Front/assets/img/gallery/emp-7.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-7.jpg"/>       
		<div class="hover-img"> 
		<h2>Logo</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item transition cms " data-category="post-transition">
	   <a href="../Front/assets/img/gallery/emp-8.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-8.jpg"/>       
		<div class="hover-img"> 
		<h2>CMS</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition ecommerce " data-category="post-transition">
         <a href="../Front/assets/img/gallery/emp-9.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-9.jpg"/>       
		<div class="hover-img"> 
		<h2>E-commerce</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition webdesign " data-category="post-transition">
		 <a href="../Front/assets/img/gallery/emp-10.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-10.jpg"/>       
		<div class="hover-img"> 
		<h2>Web Design</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item post-transition logo " data-category="post-transition">
         <a href="../Front/assets/img/gallery/emp-11.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-11.jpg"/>       
		<div class="hover-img"> 
		<h2>Logo</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item transition cms " data-category="post-transition">
	   <a href="../Front/assets/img/gallery/emp-12.jpg">	 
	    <img src="../Front/assets/img/gallery/emp-12.jpg"/>       
		<div class="hover-img"> 
		<h2>CMS</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
            ...
            <div class="row">
				...
				<p>Meet some of our lovely, passionate, positive people.</p>
                 ...
                 <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp animated" data-wow-delay=".1s">
                      <div class="blog-img">
						<img src="../Front/assets/img/blog1.JPG"/>
					  </div>
					  <div class="row">
				 ...
				 <div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".4s">
                      <div class="blog-img">
						<img src="../Front/assets/img/blog2.JPG"/>
					  </div>
					  <div class="row">
					  <div class="data">30</div>
					  <div class="month">March</div>
				 ...
				 <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInDown animated" data-wow-delay=".3s">
                      <div class="blog-img">
						<img src="../Front/assets/img/blog3.JPG"/>
					  </div>
					  <div class="row">
					  <div class="data">30</div>
					  <div class="month">March</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 wow bounceIn animated" data-wow-delay=".1s">
					...
					<form action="#" method="POST">
						<div class="ajax-hidden">
						    ...
						    <input type="reset" data-wow-delay=".3s" class="btn btn-sm btn-block wow fadeInUp animated" value="annuler">
    ...
    <script src="../Front/assets/js/jquery.js"></script>
	 <script src="../Front/assets/js/isotope-docs.min.js"></script>
    <!-- =============== Bootstrap Core JavaScript =============== -->
    <script src="../Front/assets/js/bootstrap.min.js"></script>
    <!-- =============== Plugin JavaScript =============== -->
    <script src="../Front/assets/js/jquery.easing.min.js"></script>
    <script src="../Front/assets/js/jquery.fittext.js"></script>
    <script src="../Front/assets/js/wow.min.js"></script> 
	<!-- =============== owl carousel =============== -->
    <script src="../Front/assets/owl-carousel/owl.carousel.js"></script>  
	<!-- Isotope does NOT require jQuery. But it does make things easier -->

<script src="../Front/assets/js/baguetteBox.js" async></script>
<script src="../Front/assets/js/plugins.js" async></script>
 
    <!-- =============== Custom Theme JavaScript =============== -->
    <script src="../Front/assets/js/creative.js">	</script> 
<script src="../Front/assets/js/jquery.nicescroll.min.js"></script>
