    ...
    if (
        ...
        
     {
        if (
            ...
            $reclamation->modifierreclamation($recl,$_GET["id"]);
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
						<li>
                            <a class="page-scroll" href="ajouterreclamation.php">Home</a>
                        </li>
					...
					<form action="#" method="post">
						<div class="ajax-hidden">
							<div class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
								...
								<input type="text" placeholder="Objet" name="objet" class="form-control" id="objet" required="" value = "<?php echo $_GET["objet"] ?>">
							</div>
							...
							<div data-wow-delay=".1s" class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
								...
								<input type="email" placeholder="E-mail" name="email" class="form-control" id="email" readonly pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$" value = "<?php echo $_GET["email"] ?>" required="">
							</div>
							...
							<button data-wow-delay=".3s" class="btn btn-sm btn-block wow fadeInUp animated" type="submit">Update</button>
