 ...
 ob_start();
  ...
  if (isset($_GET['id'])) {
   $reclamationController = new reclamationC();
    $result = $reclamationController->recupererreclamation($_GET['id']);
...
nullam rhoncus tortor at dignissim vehicula.</p>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownRight animated" data-wow-delay=".4s">
				...
				<div class="wbox">
					...
					<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Vestibulum ac vehicula leo dulam 
nullam rhoncus tortor at dignissim vehicula.</p>
					<a href="./reclamation/index.html" class="clr4-a">+</a>
				</div>
...
<!-- =============== Gallery =============== -->
  ...
  if (isset($_POST['modifier'])) {
                                                    $reclamation = new Reclamation($_POST['email'], $_POST['objet'], $_POST['contenu']);
                                                    $reclamationController->modifierreclamation($reclamation, $_GET['id']);
