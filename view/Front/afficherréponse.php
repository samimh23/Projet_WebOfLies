<?php
    ...
    $liste = $réponseC->afficherréponse();
?>
<!DOCTYPE html>
							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<div class="kt-portlet__body">
									...
									<table class="table" id="kt_table_event">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach($liste as $réponse){
                                            ?>
                                                <tr>
                                                    <th scope="row"><?php echo $réponse['id'] ?></th>
                                                    <td><?php echo $réponse['email'] ?></td>
                                                    <td><?php echo $réponse['objet'] ?></td>
                                                    <td><?php echo $réponse['contenu'] ?></td>
                                                    <td><?php echo $réponse['id_réponse'] ?></td>
                                                    <td>

													<a href="supprimerréponse.php?id=<?php echo $réponse['id']; ?>" class="btn">Supprimer</a>
													</td>
                                                </tr>
                                            <?php
                                                }
