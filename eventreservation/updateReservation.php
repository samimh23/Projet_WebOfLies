<?php session_start();
	...
	$id = $_GET['id'];
    $eventReservationDisplay = $EventReservationController->getEvent($id,$_SESSION['email_verif']);
	if(isset($_POST['event_reservation_lastname']) && isset($_POST['event_reservation_firstname']) && isset($_POST['event_reservation_email'])) {
		...
		$EventReservationController->updateEventreservation($EventReservation,$eventReservationDisplay['id_client']);
...
<head>
    ...
    <title>Vite fait | Update Reservation</title>
					...
					<form  id="form-event" method="post">
						<div class="ajax-hidden">
							<div class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
                                ...
                                <input type="text" class="form-control" id="event-reservation-lastname" value="<?php echo $eventReservationDisplay['name'] ?>" name="event_reservation_lastname" placeholder="Enter your Last Name here">
                                <span class="form-text" id="lastname-eventreservation-error"></span>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
								<label for="c_name" class="sr-only">FirstName</label>
                                <input type="text" class="form-control" id="event-reservation-firstname" value="<?php echo $eventReservationDisplay['prenom'] ?>" name="event_reservation_firstname" placeholder="Enter your First Name here">
                                <span class="form-text" id="firstname-eventreservation-error"></span>
                            </div>
							<div class="col-xs-12 col-sm-6 col-md-6 form-group wow fadeInUp animated">
								<label for="c_email" class="sr-only">FirstName</label>
                                <input type="email" class="form-control" id="event-reservation-email" value="<?php echo $eventReservationDisplay['email'] ?>" name="event_reservation_email" placeholder="Enter your First Name here">
