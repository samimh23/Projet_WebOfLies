...
<head>
    ...
    <title>VITE FAIT : HOME PAGE</title>
...
<body>
        ...
        <div class="container">
            <div class="header-content row">
				...
				<div id="owl-demo" class="owl-carousel header1">
				  ...
				  <h2 class="wow bounceIn animated" data-wow-delay=".60s"style="color:orange;">SIGN IN NOW</h2>
                    <h3 class="wow bounceIn animated" data-wow-delay=".40s">WE HAVE THE BEST RENTING PRICES <br/>FOR OUR CUSTOMERS</h3>
	 ...
	 <div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownLeft animated" data-wow-delay=".1s">
				...
				<div class="wbox">
					<strong>Louer ! </strong>
					<p>Cliquez pour réserver des voitures et gérer vos réservations .</p>
					<a href="../../gestion-location/location/displayghayth.php" class="clr1-a">+</a>
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownLeft animated" data-wow-delay=".2s">
				...
				<div class="wbox">
					...
					<p>Cliquez pour accéder à l'espace évènement où vous pouvez consulter nos offres.</p>
					<a href="../../event/display.php" class="clr2-a">+</a>
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownRight animated" data-wow-delay=".3s">
				...
				<div class="wbox">
					...
					<p>Cliquez ici pour bénificier des offres spéciales des hotels,maisons d'hotes...</p>
					<a href="../../gestion-logement/Views/ajouter_logement.php" class="clr3-a">+</a>
				</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3 wow rotateInDownRight animated" data-wow-delay=".4s">
				...
				<div class="wbox">
					<strong>Réclamer ! </strong>
					<p>Cliquez ici pour faire une réclamation concernant un service.</p>
					<a href="../../Reclamation/view/Front/ajouterreclamation.php" class="clr4-a">+</a>
				</div>
    ...
    <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    ...
                    <p class="copyright">
                        &copy; 2022Created By <a href="http://templatestock.co">WEB OF LIES</a>
					</p>
				...
				<div data-wow-delay=".6s" class="col-xs-12 col-sm-6 col-md-6 wow bounceIn  animated" style="visibility: visible; animation-delay: 0.6s; animation-name: bounceIn;">
					  ...
					  <section class="widget widget_text" id="text-15">
                         <h3 class="widget-title">Ferryville, Bizerte</h3> <div class="textwidget">
                        <p>Tel:97702191<br>
                      
                        E-mail: <a href="#">weboflies@gmail.com</a></p>
                       </div>
                    </section>
