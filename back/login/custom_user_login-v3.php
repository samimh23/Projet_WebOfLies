				...
				if (
					...
					foreach ($listeutilisateurs as $utilisateur) {
						...
						if (($_POST['email2'] == $utilisateur['email']) && ($_POST['password2'] == $utilisateur['pwd'])) {
							...
							// $_session['password2'] = $_POST['password2'];
							// $_SESSION['auth']=true;
							if (($_POST['email2'] == $adress) && ($_POST['password2'] == $pass)||($_POST['email2'] == "nassim.benali@esprit.tn") && ($_POST['password2'] == "nassim123")||($_POST['email2'] == "ghayth.selmi@esprit.tn") && ($_POST['password2'] == "ghayth123")||($_POST['email2'] == "sami.mahjoub@esprit.tn") && ($_POST['password2'] == "sami123")) {
								// $_SESSION['auth'] = true;
...
<head>
	...
	<script defer src="control_input.js"></script>
	<!--end::Fonts -->

	<!--begin::Page Custom Styles(used by this page) -->
	<link href="./login-v3.default.css" rel="stylesheet" type="text/css" />
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
					<div class="kt-login__container">
						...
						<div class="kt-login__signin">
							...
							<form class="kt-form" id="form" method="POST" action="">
								<div class="input-group">
									<input class="form-control" type="text" id="email2" placeholder="Email" name="email2" autocomplete="on" required>
								</div>
								<div class="input-group">
									<input class="form-control" type="password" id="password2" placeholder="Password" name="password2" required>
								</div>
								<div class="row kt-login__extra">
									...
									<div class="col kt-align-right">
										<a href="password-forgotten.php" class="kt-login__link">Forgot Password ?</a>
									</div>
								</div>
								<div class="kt-login__actions">
									<button type="submit" id="signin" class="btn btn-brand btn-elevate kt-login__btn-primary">Sign In</button>
								</div>
							</form>
						...
						<div class="kt-login__forgot">
							...
							<form class="kt-form" action="">
								...
								<div class="kt-login__actions">
									<button href="./login-system-main/recover-psw.php" id="kt_login_forgot_submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Request</button>&nbsp;&nbsp;
