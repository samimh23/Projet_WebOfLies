<?php
	...
	include_once '../Controller/LogementresC.php';

	$LogementresC = new LogementresC();
	if(isset($_POST['type_log']) && isset($_POST['nbr_eto']) && isset($_POST['prix_log']))  {
        $Logementres = new Logementres($_POST['type_log'],$_POST['nbr_eto'] ,$_POST['prix_log']);
		$LogementresC->ajouterlogementres($Logementres);
		header('Location:displaylogres.php');
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="kt-portlet">
										...
										<!--begin::Form-->
										<form id="form_log" class="kt-form" method="POST" enctype="multipart/form-data">
											<div class="kt-portlet__body">
												<div class="form-group">
													<label>Type logement:</label>
													<input type="text" class="form-control" id="type-log" name="type_log" placeholder="type log" required>
													<span class="form-text" id="typejs"></span>
												</div>
												<div class="form-group">
													<label>nombre des etoiles:</label>
													<input type="number" class="form-control" id="nbr-eto" name="nbr_eto" placeholder="nombredes etoiles" required >
													<span class="form-text" id="etoilejs"></span>
												</div>
												<div class="form-group">
													<label>prix logement:</label>
													<input type="number" class="form-control" id="prix-log" name="prix_log" placeholder="Event price" required>
													<span class="form-text" id="prixjs"></span>
												</div>
											</div>
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="submit" id="submitjs" name="submitjs" class="btn btn-primary">Submit</button>
