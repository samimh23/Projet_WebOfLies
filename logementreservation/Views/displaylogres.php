...
include_once '../Controller/LogementresC.php';
    ...
    $Logementress = $LogementresC->afficherLogementres();
?>
<!DOCTYPE html>
						...
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								<li class="kt-menu__item " aria-haspopup="true"><a href="./index.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											</svg></span><span class="kt-menu__link-text">Logement</span></a></li>
							</ul>
						</div>
					</div>
              ...
              <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                                    <div class="dropdown dropdown-inline">
                                        <a href="./addlogres.php" type="button" class="btn btn-brand btn-icon-sm" style="color: white;">
                                            <i class="flaticon2-plus"></i> Add logement
                                        </a>
                                    </div>
                </div>
              </div>
							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<div class="kt-portlet__body">
									...
									<table class="table" id="kt_table_event">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach($Logementress as $Logementres){
                                            ?>
                                                <tr>
                                                    <th scope="row"><?php echo $Logementres['id_log'] ?></th>
                                                    <td><?php echo $Logementres['type_log'] ?></td>
                                                    <td><?php echo $Logementres['nbr_eto'] ?></td>
													<td><?php echo $Logementres['prix'] ?></td>
                                                    <td>
                                                        <a href="./updateres.php?php echo $Logement['id_log'] ?>" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <a href="./supprimer.php?id=<?php echo $Logement['id_log'] ?>" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
