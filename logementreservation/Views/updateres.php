...
include_once '../Controller/LogementresC.php';
	...
	$id = $_GET['id_log'];
	$Logementres = $LogementresC->getEvent($id);
	if(isset($_POST['type_log']) && isset($_POST['nbr_eto']) && isset($_POST['prix_log']))
     {
        ...
        $LogementresC->modifierlogement($Logementres,$id);
                                        ...
                                        <form id="form-event" class="kt-form" method="POST" enctype="multipart/form-data">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													...
													<input type="number" class="form-control" id="nbr-eto" value="<?php echo $Logementres['nbr_eto'] ?>" name="nbr_eto" placeholder="nombredes etoiles">
													<span class="form-text" id="date-event-error"></span>
												</div>
												<div class="form-group">
													<label>prix logement:</label>
													<input type="number" class="form-control" id="prix-log" value="<?php echo $Logementres['prix'] ?>" name="prix_log" placeholder="Event price">
